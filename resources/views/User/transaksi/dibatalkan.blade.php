<div class="card mt-3">
    <div class="card-header bg-dark text-white">
        <div class="row">
            <div class="col">
                <span style="font-size: 0.85rem;">AR-F/ORD-20230815-0004</span>
            </div>
            <div class="col-auto">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-auto">
                <button onclick="toggleCollapse('collapse3')" class="btn btn-light collapse-button" style="border-radius: 15px;">
...
<div class="collapse" id="collapse3">
    ...
    <div class="card mb-3">
        <div class="card-body">
            <div class="d-flex justify-content-between">
                ...
                <h5 class="card-title text-muted d-flex align-items-center" style="font-size: 1rem;">AR-F/ORD-20230815-0004</h5>
            </div>
        </div>
    </div>
    <div class="mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col d-flex flex-column">
                        <img src="./gambar/produkFS.png" alt="Produk" style="max-width: 150px; border-radius: 10px;">
                    </div>
                    <div class="col d-flex flex-column">
                        <div>
    ...
    <div class="container">
        <div class="row justify-content-end">
            <div class="col-auto">
                <a href="/Detailpesananuserdibatalkan" class="btn btn-outline-dark">Detail Pesanan</a>
            </div>
        </div>
    </div>
    <hr>
