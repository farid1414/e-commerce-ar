<div class="container">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-md-4 col-6">
                <div>
                    ...
                    <p>AR-F/TRX-20230815-0004</p>
                </div>
                <div>
                    <p><b>No. Pesanan</b></p>
                    <p>AR-F/ORD-20230815-0004</p>
                </div>
            </div>
            <div class="col-xs-12 col-md-4 col-6">
                <div>
                ...
                <div>
                    ...
                    <h4><b><span class="badge rounded-pill bg-secondary text-white">Pesanan Dibatalkan</span></b></h4>
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="d-flex justify-content-between">
            ...
            <p class='fw-bold text-end'>AR-F/ORD/C4NC3L-20230815-0001</p>
        </div>
        <div class="d-flex justify-content-between">
            <p>Diminta Oleh :</p>
