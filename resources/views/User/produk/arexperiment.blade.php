...
<body>
    <div class="container">
        ...
        {{-- dropdown ini untuk simulasi saja--}}
        {{-- <div class="dropdown">
            <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
              Opsi AR
            </button>
            <ul class="dropdown-menu" id="optionsDropdown">
              <li><a class="dropdown-item" data-option="tanpa-varian">Tanpa Varian</a></li>
              <li><a class="dropdown-item" data-option="pakai-varian">Pakai Varian</a></li>
              <li><a class="dropdown-item" data-option="pakai-dimensi">Pakai Dimensi</a></li>
              <li><a class="dropdown-item" data-option="pakai-dimensi-varian">Pakai Dimensi dan Varian</a></li>
              <li><a class="dropdown-item" data-option="pakai-dimensi-custom-varian">Pakai Dimensi Custom dan Varian</a></li>
            </ul>
        </div> --}}
        <hr>
        <model-viewer
        ...
        <script>
           ...
           // Pastikan bahwa fungsi ini tetap berfungsi untuk menangani dimensi kustom dan varian
    document.addEventListener("DOMContentLoaded", function () {
    const dimensivarian = document.getElementById('dimensivarian');
    const dimControls = document.getElementById('controls');
    const colorControls = document.getElementById('color-controls');
    const dimButtons = dimensivarian.querySelectorAll('button[slot^="hotspot-dim"]');
    const dimLines = document.getElementById('dimLines');

    // Objek untuk menyimpan dimensi kustom berdasarkan warna
    ...
    // Fungsi untuk menangani perubahan pada kontrol warna
    const modelViewerColor = document.querySelector("model-viewer#dimensivarian");
    ...
    colorControls.addEventListener('click', (event) => {
        if (event.target.tagName === 'BUTTON') {
            ...
            if (colorString === "Original") {
                ...
                // Mengubah warna material sesuai dengan pilihan warna
                if (colorString === "Original") {
                    material.pbrMetallicRoughness.baseColorFactor = [1, 1, 1, 1]; // Putih untuk warna asli
                } else {
...
{{-- Dimensi --}}
      <script type="module">
        const modelViewer = document.querySelector('#dimensivarian');
