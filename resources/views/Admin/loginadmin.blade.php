...
<body>
  <nav class="navbar navbar-light bg-white">
    <div class="navbar-brand">
      <img src="./gambar/logo.png" alt="" style="max-height: 70px;">
    </div>
  </nav>
  <!-- Login Form Section -->
          ...
          <form>
            ...
            <div class="form-group">
              ...
              <div class="position-relative">
                ...
                <div class="input-group-append" onclick="togglePasswordVisibility()" style="cursor: pointer; font-size: 15px; border-radius: 0px; position: absolute; right: 10px; top: 50%; transform: translateY(-50%);">
