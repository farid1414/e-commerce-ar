...
<section class="section dashboard">
  <div class="row">
       <div>
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Pilih Jangka Waktu Bulan</h5>
            <form>
              ...
              <div class="form-group mt-3">
                <label>Bulan Akhir <span class="text-muted">(Opsional)</span></label>
                <input
                  type="date"
                  value=""
            ...
            <div class="card info-card customers-card">
              <div>
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center" style="background-color: rgb(192, 252, 230);">
            ...
            <div class="card info-card customers-card">
              ...
              <div>  
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center" style="background-color: rgb(204, 238, 255);">
    ...
    <h6>12 <span style="font-size: 1rem;">Transaksi</span></h6>
            ...
            <div class="card info-card customers-card">
              <div>
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center" style="background-color: rgb(255, 252, 189);">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p>
              Pendapatan yang berhasil diraih pada tanggal 29 Agustus 2023 hingga 30 Agustus 2023 mencapai angka luar biasa sebesar <span id="totalPendapatan"></span>.
            </p>
            <hr />
              ...
              <tbody>
                <tr>
                  <td class="text-center">
                    <img src="assets/assets/img/product-3.jpg" alt="" class="img-thumbnail" />
                  </td>
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                <tr>
                  <td class="text-center">
                    <a href="#">
                      <img src="assets/assets/img/product-5.jpg" alt="Meja" />
                    </a>
                  </td>
                  <td class="text-center">
                ...
                <tbody>
                  <tr>
                    <td style="text-align: center;">
                      <a href="#">
                        <img src="assets/assets/img/product-3.jpg" alt="Kabinet Dinding" />
                      </a>
                    </td>
                    <td style="text-align: center;">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <footer class="blockquote-footer mt-2">
                Warna pada grafik hanya berfungsi sebagai penanda untuk membedakan sebuah data dan tidak memiliki kaitan dengan aspek lainnya.
              </footer>
              ...
              <div class="d-flex justify-content-between">
                <span>5 Bintang</span>
                <span>12 <span style="font-size: 1rem;" class="text-muted">Penilaian</span>, 8 <span style="font-size: 1rem;" class="text-muted">Ulasan</span></span>
              </div>
          ...
          <div class="table-responsive mb-5">
            <table class="table table-striped table-bordered table-hover">
              <thead>
                ...
                <tr>
                  <th colspan="10" class="text-center">Laporan Penjualan Harian Tanggal 2023-08-29 hingga 2023-08-29</th>
                </tr>
                <tr>
                  <th>No.</th>
                  <th>Pelanggan</th>
