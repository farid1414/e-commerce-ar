...
<body>
    <model-viewer id="dimension-demo"
        ...
        ar ar-modes="webxr" ar-scale="fixed" camera-orbit="-30deg auto auto" max-camera-orbit="auto 100deg auto"
        shadow-intensity="2" ar-placement="wall" camera-controls touch-action="pan-y" tone-mapping="neutral"
        style="width: 100%; height: 400px; border-radius: 15px; position: relative;" xr-environment>
