            ...
            <div class="col-12 mb-0">
                <div class="card large-card">
                    <div class="card-body">
                        ...
                        <form id="adminForm" action="{{ route($this_helper . 'store-admin') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="namaAdmin" class="form-label">Nama Admin</label>
                                <input type="text" name="name" class="form-control" id="namaAdmin"
                                    placeholder="Masukkan nama admin">
                            </div>
                            <div class="mb-3">
                                <label for="emailAdmin" class="form-label">Email</label>
                                <input type="email" name="email" class="form-control" id="emailAdmin"
                            ...
                            <div class="mb-5">
                                ...
                                <div class="position-relative">
                                    <input type="password" name="password_confirmation" class="form-control"
                                        id="confirmPassword" placeholder="Masukkan kata sandi Anda" required>
                                    <div class="input-group-append"
                                        style="cursor: pointer; font-size: 15px; border-radius: 0px; position: absolute; right: 10px; top: 50%; transform: translateY(-50%);"
