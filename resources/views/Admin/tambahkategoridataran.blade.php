                ...
                <div class="card large-card">
                    <div class="card-body">
                        ...
                        <form method="POST" id="form-kategori">
                            <input type="hidden" readonly name="m_categories" id="m_categories" value="1">
                            <div class="form-group" id="gambarKategori">
                                ...
                                <div
                                    ...
                                    <img id="previewGambar" class="d-none" src="" alt="Preview"
                                        style="width: 100%; height: auto;" onclick="handleImageClick(event)" />
                            ...
                            <div class="form-group mt-3" id="namaKategori">
                                ...
                                <input type="text" value="" name="name"
                                    onchange="handleNamaKategoriChange(event)" placeholder="Masukkan nama kategori"
                                    class="form-control mb-3" required />
                            </div>
